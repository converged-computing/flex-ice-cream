module github.com/converged-computing/flex-ice-cream

go 1.16

require github.com/researchapps/flux-sched/resource/reapi/bindings/go v0.0.0-20231216202008-86f5bb331342
